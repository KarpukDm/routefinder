    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            if (b.container && !1 !== a.enabled) {
                ...
                "left" == g && (g = "start");
                "right" == g && (g = "end");
                "center" == g && (g = "middle", k ? c = b.realHeight - c + c / 2 : n = b.realWidth /
                    2 - n);
                void 0 === l && (l = 1);
                void 0 === k && (k = 0);
                c += f / 2;
        ...
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var p = this.horizontalPadding, u = this.verticalPadding, A = this.pointerWidth, x = this.pointerOrientation, z = this.cornerRadius, v = c.fontFamily, B = this.fontSize;
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN, !0), f.animate({translate: w - g + "," + B}, b, "easeOutSine"), n && (C.left = this.prevTX + "px", C.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine", "px"), this.yAnim = c.animate({node: n}, "top", this.prevTY, k, b, "easeOutSine", "px")));
                    this.prevX = w - g;
                    this.prevY = B;
                    this.prevTX = m;
                    this.prevTY = k
...
(function () {
    ...
    d.handDrawnLine = function (a, b, c, e, g, f, h, k, l, m) {
        var n, q = a.set();
        for (n = 1; n < b.length; n++)for (var t = [b[n - 1], b[n]], r = [c[n - 1], c[n]], r = d.makeHD(t, r, a.handDrawScatter), t = r[0], r = r[1], p = 1; p < t.length; p++)q.push(d.line(a, [t[p - 1], t[p]], [r[p - 1], r[p]], e, g, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
        return q
    };
    d.doNothing =
        function (a) {
...
(function () {
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop, g = this.marginBottom, f = this.horizontalGap, h = this.div, k = this.divWidth, l = this.maxColumnsReal, m = this.verticalGap, n = this.spacing, q = k - c - b, t = 0, r = 0, p = this.container;
    ...
    d.AmMap = d.Class({
        inherits: d.AmChart, construct: function (a) {
            ...
            if (a.accessibleLabel) {
                ...
                a.displayObject && this.makeAccessible(a.displayObject, b)
            }
        }, update: function () {
            ...
            if (e) {
                if (d.setCN(c, e, "selected-object"), a.bringForwardOnHover && a.displayObject.toFront(), !a.preserveOriginalAttributes) {
            ...
            var g = this.dataProvider, f = this.zoomControl, h = Math.abs(c - a), k = Math.abs(b - e), l = Math.abs(g.rightLongitude - g.leftLongitude), g = Math.abs(g.topLatitude - g.bottomLatitude), f = d.fitToBounds(h / l > k / g ? .8 * l /
            ...
            if (!this.objectWasClicked) {
                ...
                b = this.xyToCoordinates((b - this.mapContainer.x) / g - f.x * this.mapScale, (c - this.mapContainer.y) /
                    g - f.y * this.mapScale);
        ...
        getAreaCenterLatitude: function (a) {
            ...
            var a = d.degreesToRadians(this.dataProvider.leftLongitude), b = d.degreesToRadians(this.dataProvider.rightLongitude),
                c = d.degreesToRadians(this.dataProvider.topLatitude), e = d.degreesToRadians(this.dataProvider.bottomLatitude), g = a + (b - a) / 2, f = c + (e - c) / 2, h = this.dpProjectionFunction(g, c)[1], k = this.dpProjectionFunction(g, e)[1], l = this.dpProjectionFunction(a, f)[0], m = this.dpProjectionFunction(b, f)[0];
            ...
            if (this.mapSet) {
                ...
                c = e.topLatitude;
                "mercator" == e.projection ? (e = this.mercatorLatitudeToCoordinate(g), c = this.mercatorLatitudeToCoordinate(c), c = 2 * d.degreesToRadians(a * (e - c) / b + c), c = d.radiansToDegrees(2 * Math.atan(Math.exp(c)) - .5 * Math.PI)) : c =
                    a / b * (g - c) + c
            }
...
(function () {
    ...
    d.ZoomControl = d.Class({
        construct: function (a) {
            ...
            var g = c.buttonSize, f = c.zoomControlEnabled, h = c.panControlEnabled, k = c.buttonFillColor, l = c.buttonFillAlpha, m = c.buttonBorderThickness, n = c.buttonBorderColor, q = c.buttonBorderAlpha, t = c.buttonCornerRadius, r = c.buttonRollOverColor, p = c.gridHeight, u = c.zoomFactor, A = c.minZoomLevel, x = c.maxZoomLevel, z = c.buttonIconAlpha, v = c.buttonIconColor, B = c.roundButtons, C = a.svgIcons, w = a.getX(c.left), y = a.getY(c.top);
...
(function () {
    ...
    d.ImagesProcessor = d.Class({
        construct: function (a) {
            ...
            if (!isNaN(e) && !isNaN(g))c.translate(e, g, NaN, !0); else if (!isNaN(l) && !isNaN(k))if (g = b.coordinatesToXY(k, l), e = g.x, g = g.y, isNaN(t) || (e = t), isNaN(r) || (g = r), a.fixedSize) {
                t = 1;
    ...
    d.LinesProcessor = d.Class({
        construct: function (a) {
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                e = a.latitudes;
                p = n.length;
                if (0 < p)for (v = [], C = [], x = 0; x < p; x++)A = c.coordinatesToXY(n[x], e[x]), v.push(A.x), C.push(A.y);
                if (0 < v.length) {
                    a.segments = v.length;
                    d.dx = 0;
                    d.dy = 0;
                    ...
                    if ("none" != B) {
                        var I, M, N;
                        if ("end" == B || "both" == B)x = v[v.length - 1], D = C[C.length - 1], 1 < v.length ? (A = v[v.length - 2], I = C[C.length - 2]) : (A = x, I = D), I = 180 * Math.atan((D - I) / (x - A)) / Math.PI, isNaN(E) ||
                        (I += E), M = x, N = D, I = 0 > x - A ? I - 90 : I + 90;
                        r = [-t / 2 - .5, -.5, t / 2 - .5];
                        k = [t, -.5, t];
                        ...
                        "middle" == B && (x = v[v.length -
                        1], D = C[C.length - 1], 1 < v.length ? (A = v[v.length - 2], I = C[C.length - 2]) : (A = x, I = D), M = A + (x - A) / 2, N = I + (D - I) / 2, I = 180 * Math.atan((D - I) / (x - A)) / Math.PI, isNaN(E) || (E = H / 2, G -= Math.sqrt(G * G - E * E), 0 > z && (G = -G), E = Math.sin(I / 180 * Math.PI), -1 == E && (E = 1), M -= E * G, N += Math.cos(I / 180 * Math.PI) * G), I = 0 > x - A ? I - 90 : I + 90);
...
(function () {
    ...
    d.winkel3.invert = function (a, b) {
        ...
        do var h = Math.cos(e), k = Math.sin(e),
            l = Math.sin(2 * e), m = k * k, n = h * h, q = Math.sin(c), t = Math.cos(c / 2), r = Math.sin(c / 2), p = r * r, u = 1 - n * t * t, A = u ? d.acos(h * t) * Math.sqrt(x = 1 / u) : x = 0, x, u = .5 * (2 * A * h * r + c / f) - a, z = .5 * (A * k + e) - b, v = .5 * x * (n * p + A * h * t * m) + .5 / f, B = x * (q * l / 4 - A * k * r), k = .125 * x * (l * r - A * k * n * q), m = .5 * x * (m * t + A * p * h) + .5, h = B * k - m * v, B = (z * B - u * m) / h, u = (u * k - z * v) / h, c = c - B, e = e - u; while ((1E-6 < Math.abs(B) || 1E-6 < Math.abs(u)) && 0 < --g);
        return [c, e]
    };
